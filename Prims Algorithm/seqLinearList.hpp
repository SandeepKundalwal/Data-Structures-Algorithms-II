...
class LinearList{
	...
	public:
		...
		/* This constructor should create a list containing MaxSize elements. 
		* You can intialize the elements with any values.*/
		LinearList(const int& MaxListSize);

		/*
		* This constructor should create a list and initialize it with the given 2-Dimensional Array.
		*/
		// LinearList(vector<vector<int>> list);
